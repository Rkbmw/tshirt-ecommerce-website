...
import { FiShoppingCart, FiHeart, FiFilter, FiGrid, FiList, FiSearch } from 'react-icons/fi';
...
const Search = () => {
  ...
  }, [products, filters, searchQuery, setSearchParams, applyFilters]);
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          ...
          {filteredProducts.length > 0 && ` - ${filteredProducts.length} ${filteredProducts.length === 1 ? 'product' : 'products'} found`}
        </p>
      </div>
